function [PLd, PLv, APDd, APDv, MPDd, MPDv, TT] = Simulator3A(lambda,C,f,P,n,b)
% INPUT PARAMETERS:
...
for i = 1:n
    tmp = unifrnd(0, 0.02);     %packet arrivals is unif distrib between 16 ms and 24 ms
...
while (TRANSMITTEDPACKETSD + TRANSMITTEDPACKETSV) < P               % Stopping criterium
    ...
    switch Event
        ...
        case DEPARTURE                     % If first event is a DEPARTURE
            % nchoosek(PacketSize*8, 0) * b^0 * (1-b)^(PacketSize*8))
