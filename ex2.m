...
% Figure to show the asked results for 2.a) i)
figure(1);
hold on;
grid on;
...
% Figure to show the asked results for 2.a) ii)
figure(2);
hold on;
grid on;
...
% Figure to show the asked results for 2.a) iii)
figure(3);
hold on;
grid on;
...
% Figure to show the asked results for 2.a) iv)
figure(4);
hold on;
grid on;
...
% delay aumenta em geral porque há mais flows
% delay no data é ligeiramente maior porque os pacotes de dados sao maiores
% packet loss é maior nos dados porque os pacotes de dados são maiores, logo
% para o mesmo ber tem maior probabilidade de causa erros (ver avg_bytes)
% packet loss matem-se constante cosoante o nr de flows porque a ligacao
% nao esta saturada aka a queue é grande